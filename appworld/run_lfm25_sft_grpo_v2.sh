#!/bin/bash
# GRPO v2 — LFM2.5 SFT checkpoint, fixed: higher max_model_len + LFM stop word + lower LR
...
export TRAJECTORY_LOG=/tmp/appworld_lfm25_trajectories_v2.jsonl
...
MODEL_PATH=output/appworld_lfm25_sft_v2/v1-20260427-023006/checkpoint-24
RUN_NAME="appworld_lfm25_sft_grpo_v2_$(date +%Y%m%d_%H%M%S)"
...
swift rlhf \
    ...
    --report_to wandb \
    --run_name "$RUN_NAME" \
    --output_dir output/appworld_lfm25_sft_grpo_v2
