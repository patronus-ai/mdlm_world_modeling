#!/bin/bash
# GRPO — Qwen3-4B on AppWorld RL tasks with WM
...
export TRAJECTORY_LOG=/tmp/appworld_trajectories.jsonl
...
# Pass MODEL_PATH=output/appworld_qwen3_sft_final/v0-20260425-213632/checkpoint-28
MODEL_PATH=output/appworld_qwen3_sft_final/v0-20260425-213632/checkpoint-28
RUN_NAME="appworld_qwen3_grpo_clean_$(date +%Y%m%d_%H%M%S)"
...
swift rlhf \
    ...
    --report_to wandb \
    --run_name "$RUN_NAME" \
    --output_dir output/appworld_qwen3_grpo_final
